...
Form::Form(std::string name, int sR, int const eR)
...
bool const& Form::getSigned() const { return (isSigned); }

int const& Form::getSignReq() const { return (signReq); }

int const& Form::getExeReq() const { return (exeReq); }
