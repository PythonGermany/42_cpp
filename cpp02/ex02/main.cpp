...
int main(void)
{
	...
	std::cout << a << " is equal to / smaller than " << c << ": " << (a <= c) << std::endl;
	std::cout << a << " is equal to / greater than " << c << ": " << (a >= c) << std::endl;
	std::cout << a << " is equal to / smaller than " << d << ": " << (a <= d) << std::endl;
